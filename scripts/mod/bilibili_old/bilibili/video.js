const cheerio = require("cheerio"),
  ...
  getVideoData = (vid, page, quality, access_key) => {
    $ui.loading(true);
    $http.get({
                          ...
                          case 1:
                            $ui.menu({
                              ...
                              handler: function (titlePlayer, idxPlayer) {
                                switch (idxPlayer) {
                                  case 0:
                                    appScheme.Video.AVPlayer(_data);
                                    break;
                                  case 1:
                                    appScheme.Video.NPlayer(_data);
                                    break;
                                }
                              }
                            });
                            break;
                          case 2:
                            appScheme.Browser.Alook.open(_data);
                            break;
                        }
                      }
                    });
