                    ...
                    menu: {
                      ...
                      items: [
                        ...
                        },
                        {
                          ...
                          handler: (sender, indexPath) => {
                            getVtbLiveroomInfo(
                              medalList[indexPath.row].target_id
                            );
                          }
                        },
                        {
                        ...
                        },
                        {
                          ...
                          handler: (sender, indexPath) => {
                            const liveData = medalList[indexPath.row];
                            if (
                              liveData.medal_level < 20 &&
                              liveData.day_limit - liveData.today_feed > 0
                            ) {
                ...
                views: [
                  {
                    ...
                    events: {
                      didSelect: function (_sender, indexPath, _data) {
                        ...
                        const liveTime =
                          $$.Time.getNowUnixTimeSecond() - thisRoom.live_time;
                        $ui.push({
                          props: {
                  ...
                  data: [
                    {
                      ...
                      rows: [
                        ...
                        `直播：${
                          liveroomInfo.liveStatus === 1 ? "直播中" : "未直播"
                        }`,
                      ...
                      case 1:
                        switch (row) {
                          case 0:
                            ...
                            break;
                          case 1:
                            appScheme.Browser.Safari.Preview(liveroomInfo.face);
                            break;
                          case 2:
                            getLiveroomGuardList(
                              liveroomInfo.roomid,
